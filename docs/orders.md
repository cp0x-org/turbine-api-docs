...
```jsonc
{
  "owner":          "0x15cCf087670A46e54d71Bd1DE429dDE0c372D17f", // must match SIWE-authed wallet
  ...
  "salt":           "0xa2a03821...7b74415"  // 32 random bytes as hex
}
```
...
```json
{ "orderHash": "0xe5e705c088dfce48ebce881c45ceaa33ddf00087af0d23eccc91393d64c12634" }
```
